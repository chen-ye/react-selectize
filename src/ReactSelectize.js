(function(){
  var ref$, each, filter, find, findIndex, initial, last, map, objToPairs, partition, reject, reverse, sortBy, sum, clamp, isEqualToObject, React, div, input, span, createClass, createFactory, findDOMNode, Transition, cancelEvent, OptionWrapper, ValueWrapper;
  ...
  module.exports = createClass({
    ...
    render: function(){
      ...
      return div({
        ...
        springParams: this.props.springParams,
