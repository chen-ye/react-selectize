(function(){
  var ref$, each, filter, find, findIndex, id, initial, last, map, objToPairs, partition, reject, reverse, sortBy, sum, values, clamp, isEqualToObject, React, div, input, span, createClass, createFactory, findDOMNode, ReactMotion, Transition, cancelEvent, OptionWrapper, ValueWrapper;
  ...
  Transition = createFactory(require('react-motion-ui-pack'));
  ...
  module.exports = createClass({
    ...
    render: function(){
      ...
      return div({
        ...
        component: 'div',
        enter: {
          height: ReactMotion.spring('auto', this.props.springParams),
          opacity: 1
        },
        leave: {
          height: ReactMotion.spring(0, this.props.springParams),
          opacity: 0
        },
        className: 'dropdown-transition',
        ref: 'dropdown-transition'
      }, this.props.open ? (renderOptions = function(options){
        return map(function(index){
          var option, uid;
        ...
        : ((ref$ = this.props) != null ? (ref1$ = ref$.groups) != null ? ref1$.length : void 8 : void 8) > 0
          ...
          groups))))
          : renderOptions(this.props.options))) : void 8));
    },
